// GENERATED by `dart run mongobase:setup` — do not edit.
// Source of truth: mongobase.yaml
import 'package:mongobase/mongobase.dart';

/// The app schema, mirroring mongobase.yaml.
final mongobaseSchema = MongobaseSchema([
...
///
/// ```dart
/// final todos = await MongobaseDb.todos.find();
/// ```
...
class Todo {
  ...
  /// Empty until the document has been inserted — mongobase
